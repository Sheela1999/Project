        ...
        <br><br>
          <div class="card" style="border-radius: 50px;">
            <div class="card-body p-5">
              ...
              <form action="saveUserRecords" method="post">

                <div class="form-outline mb-3">
                  <input type="text" id="form3Example1cg" class="form-control form-control-lg" name="name" placeholder="Your Name" required />
                </div>
                ...
                <div class="form-outline mb-3">
                  <input type="number" id="form3Example3cg" class="form-control form-control-lg" name="mobileNumber" placeholder="Your MobileNo" required />
                  </div>
                  <h5 style="color: red;">${MobileNumber}</h5>
                
                <div class="form-outline mb-3">
                  <input type="number" id="form3Example3cg" class="form-control form-control-lg"  name="aadharNumber"placeholder="Your AadhaarNo" required/>
                </div>
                ...
                <div class="form-outline mb-3">
                  <input type="password" id="form3Example4cdg" class="form-control form-control-lg" name="confirmPassword" placeholder="Confirm Password" required />
                  </div>
                ...
                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="UserSignIn.jsp"
